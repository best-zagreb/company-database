...
function handleEditContact(e, id) {
  // TODO: make a PUT request na /users/{id}/contacts/{id} and then update contacts list
  console.log("Editing a contact is not yet implemented!");
  // setEditFormModal(true);
}

function handleDeleteContact(e, id) {
  // TODO: make a DELETE request na /users/{id}/contacts/{id} and then update contacts list
