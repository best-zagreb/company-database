\chapter{Arhitektura i dizajn sustava}
		...
		{Klijent koristi Web aplikaciju, prikazanu u pregledniku, te preko nje šalje zahtjeve Web poslužitelju. Nakon obrade podataka, Web poslužitelj vraća odgovor aplikaciji koja ga potom prikazuje korisniku.}\vspace{0.3cm}
