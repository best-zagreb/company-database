\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Sekvencijski dijagrami}
				...
				\textit{Korisnik (administrator) šalje zahtjev za prikaz korisnika kako bi mogao stvoriti novog.
				...
				\begin{figure}[H]
					...
					\centering
					\caption{Slika 3.6: Sekvencijski dijagram za UC3}
					\label{fig:UC3}
				\end{figure}

				\textbf{Obrazac uporabe UC13 - Stvaranje suradnje za dodijeljen projekt}

				\textit{Korisnik šalje zahtjev za prikaz projekata kako bi mogao stvoriti novu suradnju.
				...
				\begin{figure}[H]
					...
					\centering
					\caption{Slika 3.7: Sekvencijski dijagram za UC13}
					\label{fig:UC13}
				\end{figure}

				\textbf{Obrazac uporabe UC15 - Stvaranje projekta}

				\textit{Korisnik šalje zahtjev za prikaz projekata kako bi mogao stvoriti novi.
				Aplikacija dohvaća trenutne projekte i prikazuje ih.
				...
				\begin{figure}[H]
					...
					\centering
					\caption{Slika 3.8: Sekvencijski dijagram za UC15}
					\label{fig:UC15}
				\end{figure}

				\textbf{Obrazac uporabe UC23 - Stvaranje kompanije}

				\textit{Korisnik šalje zahtjev za prikaz kompaija kako bi mogao stvoriti novu.
				...
				\begin{figure}[H]
					\includegraphics[scale=0.4]{slike/Sekvencijski dijagrami/UC23 - Stvaranje kompanije}
					\centering
					\caption{Slika 3.9: Sekvencijski dijagram za UC23}
					\label{fig:UC23}
				\end{figure}
